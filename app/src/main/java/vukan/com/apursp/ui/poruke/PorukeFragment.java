...
public class PorukeFragment extends Fragment implements MessageAdapter.ListItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        porukeViewModel.getProductDetails(productID).observe(getViewLifecycleOwner(), product -> receiverId = product.getUserID());

        porukeViewModel.getmMessages(Objects.requireNonNull(fire_user).getUid(), receiverId).observe(getViewLifecycleOwner(), message -> {
